...
function Home() {
  ...
  return (
    ...
    >
      <Head>
        <title>ThorNode Staking UI</title>
        <meta name="description" content="ThorNode Staking UI, powered by Cardinal" />
      ...
      >
        {(!stakePool && stakePoolLoaded) || stakePoolMetadata?.notFound ? (
          ...
          !wallet.connected && (
            <div
              className={`mx-5 mb-5 cursor-pointer rounded-md border-[1px] max-w-md mr-auto ml-auto p-4 text-center text-lg font-semibold ${
